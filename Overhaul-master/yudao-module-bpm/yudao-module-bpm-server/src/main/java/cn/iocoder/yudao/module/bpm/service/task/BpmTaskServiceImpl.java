...
import cn.iocoder.yudao.module.bpm.api.task.dto.BpmTaskPageReqVO;
import cn.iocoder.yudao.module.bpm.api.task.dto.BpmTaskApproveReqVO;
import cn.iocoder.yudao.module.bpm.api.task.dto.BpmTaskRejectReqVO;
...
//        }
    ...
    public void approveTask(Long userId, @Valid BpmTaskApproveReqVO reqVO) {
        // 输出reqVO
        log.info("【用户({})】提交审批任务，任务编号：{}", userId, reqVO);
        // 1.1 校验任务存在
