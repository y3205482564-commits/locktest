...
import { BpmAutoApproveType, BpmModelFormType, ProcessVariableEnum } from '@/enums';
import {
  HttpRequestSetting,
  parseFormFields,
...
/** 自定义打印模板模态框 */
const [registerPrintTemplateModal, { openModal: openPrintTemplateModal }] = useModal();

/** 弹出自定义打印模板弹窗 */
function handleOpenPrintTemplateModal() {
  openPrintTemplateModal(true, { template: modelData.value.printTemplateSetting.template });
}
...
<template>
  ...
  >
    ...
    <FormItem v-if="modelData.processIdRule" class="mb-5" label="流程编码">
      ...
      <div v-if="modelData.processIdRule.enable" class="ml-6 mt-2">
              ...
              <Radio :value="true">
                <div class="inline-flex items-center">
                  ...
                  <Tooltip
                    ...
                    placement="top"
                  >
                    <Icon icon="lucide:circle-help" class="size-4 ml-1 text-gray-500" />
                  </Tooltip>
                </div>
              </Radio>
            </Col>
      ...
      <div class="w-full flex flex-col">
        <div class="flex items-center">
          ...
          <Button
            ...
            type="link"
            @click="handleOpenPrintTemplateModal"
          >
            <template #icon>
    ...
    <!-- TODO: 打印模板弹窗 -->
    <PrintTemplate :form-fields="formFields" @register="registerPrintTemplateModal" @confirm="confirmPrintTemplate" />
  </Form>
</template>
