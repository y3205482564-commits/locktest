...
import { BpmModelFormType, BpmNodeTypeEnum } from '@/enums';
...
const [registerDrawer, { closeDrawer, setDrawerProps }] = useDrawerInner(() => {
  // 在打开时不做任何操作，由 showStartUserNodeConfig 方法处理
});
 ...
 * 暴露方法给父组件
 */
defineExpose({ showStartUserNodeConfig, registerDrawer });
</script>
