...
interface ChildProcessFormType {
  approveRatio: number
  async: boolean
    ...
    <template #title>
      <div class="config-header">
        ...
        <div v-else class="node-name">
          {{ nodeName }}
          <Icon class="ml-1" icon="lucide:edit-3" @click="clickIcon()" />
        </div>
      </div>
    </template>
      ...
      >
        ...
        <FormItem label="主→子变量传递" name="inVariables">
          ...
          >
            <div class="mr-2">
              ...
              >
                <Select v-model:value="item.source" class="!w-40">
                  <SelectOption
            ...
            <div class="mr-2">
              ...
              >
                <Select v-model:value="item.target" class="!w-40">
                  <SelectOption
            ...
            <div class="mr-1 h-8 flex items-center">
              <Icon
                icon="lucide:trash-2"
                :size="18"
        ...
        <div v-if="configForm.timeoutEnable">
          ...
          >
            <Row :gutter="8">
              <Col>
                <span class="h-8 inline-flex items-center"> 当超过 </span>
              </Col>
              <Col>
              ...
              <Col>
                <span class="h-8 inline-flex items-center">后进入下一节点</span>
              </Col>
            </Row>
          </FormItem>
          <FormItem
