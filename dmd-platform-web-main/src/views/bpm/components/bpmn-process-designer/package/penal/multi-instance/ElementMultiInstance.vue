  ...
  <div class="panel-tab__content">
    ...
    <Form class="hidden">
      <FormItem label="快捷配置">
        ...
        <Button size="small" @click="() => changeConfig('会签')">
          会签
        </Button>
        <Button size="small" @click="() => changeConfig('或签')">
          或签
        </Button>
      </FormItem>
      <FormItem label="会签类型">
      ...
      <template
        ...
        "
      >
        <FormItem key="loopCardinality" label="循环数量">
          <Input
        ...
        <FormItem v-show="false" key="collection" label="集合">
          <Input
        ...
        <FormItem key="elementVariable" label="元素变量" class="hidden">
          <Input
        ...
        <FormItem key="completionCondition" label="完成条件">
          <Input
        ...
        <FormItem key="async" label="异步状态" class="hidden">
          <Checkbox
