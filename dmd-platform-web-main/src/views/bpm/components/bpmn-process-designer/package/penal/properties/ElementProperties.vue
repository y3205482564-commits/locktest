...
<template>
  <div class="panel-tab__content">
    <Table :data-source="elementPropertyList" size="small" bordered>
    ...
    >
      <Form ref="attributeFormRef" :model="propertyForm">
      ...
      <template #footer>
        <Button @click="propertyFormModelVisible = false">
          取 消
        </Button>
        <Button type="primary" @click="saveAttribute">
          确 定
        </Button>
      </template>
    </Modal>
