...
<template>
  <div class="panel-tab__content">
    ...
    >
      <Form ref="listenerFormRef" :model="listenerForm">
        <FormItem
          label="事件类型"
          name="event"
          :rules="[
        ...
        >
          <Select v-model:value="listenerForm.event">
            <SelectOption value="start">
              start
            </SelectOption>
            <SelectOption value="end">
              end
            </SelectOption>
          </Select>
        </FormItem>
      ...
      <div class="mb-2 flex justify-between">
        <span class="flex items-center">
          <Icon icon="ep:menu" class="mr-2 text-gray-600" />
          注入字段
        </span>
        <Button
          type="primary"
      ...
      <div class="element-drawer__button">
        <Button @click="listenerFormModelVisible = false">
          取 消
        </Button>
        <Button type="primary" @click="saveListenerConfig">
          保 存
        </Button>
      </div>
    </Drawer>
    ...
    <Modal
      ...
      :destroy-on-close="true"
    >
      <Form ref="listenerFieldFormRef" :model="listenerFieldForm">
        <FormItem
          label="字段名称："
          name="name"
          :rules="[
