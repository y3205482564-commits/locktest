...
import { UndoOutlined, ZoomInOutlined, ZoomOutOutlined } from '@/icons/iconify';

import { Button, ButtonGroup, Modal, Row, Table } from 'ant-design-vue';
import BpmnViewer from 'bpmn-js/lib/Viewer';
import MoveCanvasModule from 'diagram-js/lib/navigation/movecanvas';
import { formatDate, formatPast2 } from '@/utils/date';
import { BpmProcessInstanceStatus } from '@/enums';
...
<template>
  <div class="process-viewer">
    <div v-show="!isLoading" ref="processCanvas" style="height: 100%" />
