...
import { Button, ButtonGroup, Modal, Tooltip, message } from 'ant-design-vue';

// @ts-expect-error bpmn-js-token-simulation 没有类型定义
import tokenSimulation from 'bpmn-js-token-simulation';
import BpmnModeler from 'bpmn-js/lib/Modeler';
import hljs from 'highlight.js';
import { XmlNode, parseXmlString } from 'steady-xml';
...
<template>
  <div class="my-process-designer">
    ...
    >
      <div>
        <pre><code v-dompurify-html="highlightedCode(previewResult)" class="hljs" /></pre>
      </div>
    </Modal>
  </div>
</template>
