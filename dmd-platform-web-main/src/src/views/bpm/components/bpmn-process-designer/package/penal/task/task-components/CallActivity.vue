...
import { Modal as AModal, Button, Divider, Form, FormItem, Input, Modal, Switch, Table, TableColumn } from 'ant-design-vue';

import { PlusOutlined } from '@/icons/iconify';
...
<template>
  <div>
    ...
    >
      <Form ref="varialbeFormRef" :model="varialbeFormData">
