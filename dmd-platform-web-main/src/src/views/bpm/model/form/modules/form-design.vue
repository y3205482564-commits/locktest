...
import { BpmModelFormType } from '@/enums';
...
<template>
  ...
  >
    ...
    >
      <div class="flex items-center">
        ...
        <Tooltip
          ...
          placement="top"
        >
          <Icon icon="lucide:circle-help" class="size-5 ml-1 text-gray-900" />
        </Tooltip>
      </div>
    </FormItem>
    <FormItem
    ...
    <div
      ...
      "
      class="mb-5 mt-7 border border-gray-200 rounded-sm border-solid p-5"
    >
      <div class="mb-4 flex items-center">
        <div class="mr-2 h-4 w-1 bg-blue-500" />
